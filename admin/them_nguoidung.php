              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      <!-- Put your code here -->
                      <form class="form-horizontal form-label-left" novalidate action="controller_them_nguoidung.php" method="post">
                        ...
                        <div class="form-group">
        					...
        					<div class="col-md-6 col-sm-6 col-xs-12">
        						<input id="datepicker" readonly class="form-control" type="text" name="ngaysinh" value="1/1/1990" class="input-medium" />
        					</div>
        				</div>
                        ...
                        <div class="item form-group">
	                      	...
	                      	<div class="col-md-6 col-sm-6 col-xs-12"	>
	                        	<textarea required="required" name="diachi" class="form-control col-md-7 col-xs-12"></textarea>
	                      	</div>
                    	</div>
                        <div class="item form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12"
